        ...
        if content_type == 'text':
            ...
            if (msg_text.startswith('/')):
                ...
                if (self.state == CHOOSE_EVENT_CATEGORY and command == 'events' ):
                    ...
                    event_categories = ('Technology', 'Culture', 'Music', 'Dance', 'Sports', 'Miscellaneous','Search')
            ...
            elif (msg_text == 'Technology' or 'Culture' or 'Music' or 'Dance' or 'Sports' or 'Miscellaneous' or 'search'):
                ...
                elif (msg_text == 'Search':
                    response = 'Please enter the name of the event you want to search for : '
                    bot.sendMessage(chat_id,response)
                    var = msg['text']
                    database_events = [var]
                else:
